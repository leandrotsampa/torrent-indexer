...
```bash
curl -s https://raw.githubusercontent.com/leandrotsampa/torrent-indexer/main/docker-compose.yml > docker-compose.yml
docker-compose up -d
```

The server will be available at [http://localhost:8080/](http://localhost:8080/).

Docker image: `ghcr.io/leandrotsampa/torrent-indexer:latest`
...
description: "Indexing Brazilian Torrent websites into structured data. github.com/leandrotsampa/torrent-indexer"
language: pt-BR
type: public
encoding: UTF-8
links:
